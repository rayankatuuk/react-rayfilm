    ...
    <div className="mb-3 sm:mb-4">
      ...
      <div className="relative">
        <input 
          ...
          onChange={onChange}
          required={required}
          className={`w-full px-3 py-2 sm:px-4 sm:py-2 rounded-full border border-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 pr-8 sm:pr-10 text-black ${className}`}
          {...props}
        />
        <button
          type="button"
